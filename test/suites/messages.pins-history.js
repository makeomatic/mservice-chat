...
describe('messages.pins-history', function suite() {
  ...
  before('create second room', () => chat.services.room
  ...
  it('should not be able to get pins history if not authorized', () => request(uri, { roomId: this.roomId })
    .then((response) => {
  ...
  it('should not be able to get pins history if not admin', () => request(uri, { roomId: this.roomId, token: this.userToken })
    .then((response) => {
      const { body, statusCode } = response;
  ...
  it('should not be able to pin in non existent room', () => request(uri, { roomId: fakeRoomId, token: this.adminToken })
    .then((response) => {
      const { body, statusCode } = response;
  ...
  it('should be able to return pins history', () => request(uri, { roomId: this.roomId, token: this.adminToken })
    .then((response) => {
